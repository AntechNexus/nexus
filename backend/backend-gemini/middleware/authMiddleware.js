/**
 * Middleware to authenticate requests to the AI service.
 * Extracts the Bearer token from the Authorization header and verifies it
 * against the authentication service (Nexus backend). If valid, attaches the user object to the request.
 *
